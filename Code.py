...
#Exploring the dataset and its characteristics
...
#Predicting target variable using normalized features
m = X_norm.shape[0]
yp = np.zeros(m)
for i in range(m):
    yp[i] = np.dot(X_norm[i], w_norm) + b_norm

# Ploting predictions and targets versus original features
fig,ax=plt.subplots(1,4,figsize=(12, 3),sharey=True)
for i in range(len(ax)):
...
#Predicting the price of a 1200 squared ft house with 3 rooms , 1 floor , 40 years old   
